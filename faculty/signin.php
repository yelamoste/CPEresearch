          ...
          <div class="col" style="height: 100vh;">
            <div class="form-cont" style="margin-top: 105px;">
                ...
                <div class="text-center mt-3 px-5">
                    ...
                    <!-- FORM HERE -->
                    <form action="faculty-main.php" method="POST" accept-charset="UTF-8">
                        <div class="mb-3 py-1">
                            <input type="email" class="form-control" name="facultySigninEmail" id="facultySigninEmail" placeholder="PUP webmail"/>
                        </div>
                        <div class="mb-3 py-1">
                            <input type="password" class="form-control" name="facultySigninPass" id="facultySigninPass" placeholder="Password"/>
                        </div>
                        <div class="mb-3 py-1 d-grid">
                            <button type="submit" class="btn btn-primary text-ghostwhite" name="btnSignin">
                            ...
                            <div class="mt-2 text-end">
                                ...
                                <a href="../faculty/signup.php" class="ps-2 text-secondary text-decoration-none">Sign Up here</a>
                            </div>
                        </div>
                    </form>
                    <!-- END OF FORM HERE -->

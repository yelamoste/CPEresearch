...
$sql = "UPDATE student SET reset_token_hash = ?, reset_token_expires_at = ? WHERE webmail = ?";
...
if ($stmt->affected_rows) {
    if ($mail) {
        ...
        $mail->Body = <<<END
        Click <a href="http://localhost/CPEResearch/php/StudentresetPassword.php?token=$token">here</a> to reset your password.
        END;
